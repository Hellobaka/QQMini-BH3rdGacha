...
{
    public class JZA1 : IOrderModel
    {
        public string GetOrderStr()
        {
            return PublicArgs.order_JZA1;
        }
        public bool Judge(string destStr)
        {
            return destStr.Replace(" ", "").ToUpper() == GetOrderStr()
                && Save.AppConfig.Object["ExtraConfig"]["SwitchJZA1"].GetValueOrDefault("1") != "0";
        }
        public FunctionResult Progress(QMGroupMessageEventArgs e)
        {
            ...
            {
                MainGacha.JZ_GachaMain(PublicArgs.PoolName.精准A),
            ...
            sendText.MsgToSend.Add(ini.Object["详情"]["A_ResultAt"].GetValueOrDefault("0") == "1"
                ...
                ? Helper.TextGacha(ls) : $"[pic=" +
                    $"{cp.MakePic(ls, PublicArgs.PoolName.精准A,  diamond - 280, e.FromQQ.Id, e.FromGroup.Id)}]");
            return result;
        }
